...
const support_detect_1 = require("./core/support-detect");
var support_detect_2 = require("./core/support-detect");
Object.defineProperty(exports, "Support", {
  enumerable: true,
  get: function () {
    return support_detect_2._Support;
  },
});
const ansi_codes_1 = require("./core/ansi-codes");
const ansi_color_map_1 = require("./core/ansi-color-map");
const theme_1 = require("./core/theme");
const ansi_console_1 = require("./ansi-console");
var ansi_console_2 = require("./ansi-console");
Object.defineProperty(exports, "log", {
  enumerable: true,
  get: function () {
    return ansi_console_2.logAnsi;
  },
});
Object.defineProperty(exports, "isBrowser", {
  enumerable: true,
  get: function () {
    return ansi_console_2.isBrowser;
  },
});
Object.defineProperty(exports, "getRgbFrom256Index", {
  enumerable: true,
  get: function () {
    return ansi_console_2.getRgbFrom256Index;
  },
});
Object.defineProperty(exports, "toConsoleArgsFromAnsiNext", {
  enumerable: true,
  get: function () {
    return ansi_console_2.toConsoleArgsFromAnsiNext;
  },
});
/**
...
const _get_safemap_and_graylist_args = (bg) => {
  ...
  let mapListArgs = [bg ? ansi_color_map_1._color_bg_web_safe_map : ansi_color_map_1._color_web_safe_map, bg ? ansi_color_map_1._color_bg_web_safe_list : ansi_color_map_1._color_web_safe_list];
  if (_more_detail_on_color256) {
    mapListArgs = [mapListArgs[0], mapListArgs[1], bg ? ansi_color_map_1._color_bg_gray_map : ansi_color_map_1._color_gray_map, bg ? ansi_color_map_1._color_bg_gray_list : ansi_color_map_1._color_gray_list];
  }
  return mapListArgs;
};
...
const _get_web_safe_code_by_rgb = (r, g, b, map, list, map2, list2) => {
  let hex = (0, ansi_color_map_1.n2h)(r) + (0, ansi_color_map_1.n2h)(g) + (0, ansi_color_map_1.n2h)(b);
  /** @type {string | null=} */
  let c = map[hex];
  if (c) return c;
  if (map2) {
...
const _get_code = (color) => {
  ...
  /** @type {number} */
  let code = ansi_codes_1._codes_base[/** @type {TCodesBaseKey} */ (color)];
  if (code !== void 0) return `\x1b[${code}m`;
  code = ansi_codes_1._codes_advanced[/** @type {TCodesAdvanceKey} */ (color)];
...
const _check_reset_end = (value) => {
  return value.length >= 4 && value.endsWith(ansi_codes_1._reset_ctrl);
};
...
const emitColorsFunction = (ansiEscape) => {
  return function () {
    ...
    else return ansiValue + ansi_codes_1._reset_ctrl;
  };
};
const _codes_init = () => {
  for (const key in ansi_codes_1._codes_base) {
    _defineStringProp(key, emitColorsFunction(`\x1b[${ansi_codes_1._codes_base[/** @type {TCodesBaseKey} */ (key)]}m`));
  }
  for (const key in ansi_codes_1._codes_advanced) {
    _defineStringProp(key, emitColorsFunction(`\x1b[${ansi_codes_1._codes_advanced[/** @type {TCodesAdvanceKey} */ (key)]}m`));
  }
  ...
  const _color_at_256_or_gray_impl = (dis, idxOrLevel, flag, fn) => {
    ...
    else return code + dis + ansi_codes_1._reset_ctrl;
  };
  ...
  _strProto.colors =
    ...
    function (color, noreset) {
      return (0, exports.colors)(color, this, noreset);
    };
  ...
  const emit_hex_fn = (isBg = false) =>
    function (hex) {
      ...
      if (!code) return this;
      return code + this + ansi_codes_1._reset_ctrl;
    };
  ...
  const emit_rgb_fn = (isBg = false) =>
    ...
    function (r, g, b) {
      ...
      return ansiMark + this + ansi_codes_1._reset_ctrl;
    };
  ...
  _strProto.paint =
    ...
    function (pt) {
      return (0, exports.paint)(pt, this);
    };
...
const _theme_init = () => {
  for (const key in theme_1._theme) {
    _defineStringProp(key, function () {
      if (_enable) {
        let s = theme_1._theme[key];
        if (!s) return this;
        return (0, exports.colors)(s, this);
      }
      return this;
    });
  }
...
const _init = () => {
  _support = (0, support_detect_1.detectSupport)();
  if ((0, support_detect_1.isDefined)()) return;
  (0, support_detect_1.setDefined)();
  _codes_init();
  _theme_init();
};
_init();
/** @type {(color: string | string[], value: string, noreset?: boolean) => string} */
const colors = (color, value, noreset) => {
  if (_enable && _support >= 1 /* Support.BASE */) {
    if (typeof color === "string") {
      let s = theme_1._theme[color];
      if (s) return (0, exports.colors)(s, value);
      var code = _get_code(color);
      if (!code) return value;
      if (noreset) return code + value;
      return code + value + ansi_codes_1._reset_ctrl;
    } else {
      let result = value;
      ...
      return result + ansi_codes_1._reset_ctrl;
    }
  }
  return value;
};
 ...
 */
const position = (x, y) => {
  if (ansi_console_1.isBrowser || !_enable) return;
...
exports.save_position = save_position;
const load_position = () => {
  if (ansi_console_1.isBrowser || !_enable) return;
  process.stdout.write("\u001B[u" /* ECtrlCode.loadPositionCode */);
};
exports.load_position = load_position;
const clear_screen = () => {
  if (ansi_console_1.isBrowser || !_enable) return;
 ...
 * @param {boolean=} value
 */
const more_detail_on_color256 = (value = true) => {
